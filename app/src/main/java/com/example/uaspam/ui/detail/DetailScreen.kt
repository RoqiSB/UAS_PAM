...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            aplikasi  = detailUIState.addEvent.toApp(), modifier = Modifier.fillMaxWidth()
        )
...
@Composable
fun ItemDetails(
    aplikasi: Aplikasi, modifier: Modifier = Modifier
) {
    Card(
